...
export default function HomePage() {
  ...
  const dayAfterTomorrow = useMemo(() => new Date(tomorrow.getTime() + 86400000), [tomorrow]);
  ...
  const fetchAll = useCallback(async () => {
    ...
    // Jams — toutes les 2 prochains jours pour avoir les données des deux filtres
  ...
  if (isLoading) return (
    <div className="space-y-3 p-4">
      <div className="h-8 w-48 bg-zik-card animate-pulse rounded" />
